...
public class TranslationApiTest {
     ...
     */
    @Test
    public void automaticTranslationTest() throws Exception {
        String text = "ceci est un texte";
        String sourceLanguage = "fr-FR";
        String targetLanguage = "en-US";
        String providers = "['amazon']";
        InlineResponse2009 response = api.automaticTranslation(text, sourceLanguage, targetLanguage, providers);
        assertNotNull(response);
        assertNotNull(response.getResult().get(0).getResult().getSourceLanguage());
        assertNotNull(response.getResult().get(0).getResult().getTargetLanguage());
        assertNotNull(response.getResult().get(0).getResult().getTranslatedText());
    }
    ...
    public void languageDetectionTest() throws Exception {
        String text = "ceci est un texte";
        String providers = "['amazon']";
        InlineResponse20010 response = api.languageDetection(text, providers);
        assertNotNull(response);
        assertNotNull(response.getResult().get(0).getResult().getText());
        assertNotNull(response.getResult().get(0).getResult().getConfidences());
        assertNotNull(response.getResult().get(0).getResult().getLanguages());
    }
