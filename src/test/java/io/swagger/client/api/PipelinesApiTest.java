...
public class PipelinesApiTest {
     ...
     */
    @Test
    public void pipelinesTest() throws Exception {
        String description = "[ { \"feature\": \"ocr\", \"params\": { \"providers\": \"['amazon']\",\"language\": \"en-US\" } }]";
        Boolean returnOnlyLast = true;
        String text = "ceci est un texte";
        File files = new File("/home/michel/Desktop/meuble.png");
        InlineResponse200 response = api.pipelines(description, returnOnlyLast, text, files);
