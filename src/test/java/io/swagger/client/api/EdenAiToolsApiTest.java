...
/**
 * API tests for EdenAiToolsApi
 */
public class EdenAiToolsApiTest {

    private final EdenAiToolsApi api = new EdenAiToolsApi();
    ...
    public void searchTest() throws Exception {
        ...
        String words = "['aze','est','texte']";
        InlineResponse20014 response = api.search(text, words);
        assertNotNull(response.getResult().getExecutionTime());
        assertNotNull(response.getResult().getStatus());
        assertNotNull(response.getResult().getResult());
